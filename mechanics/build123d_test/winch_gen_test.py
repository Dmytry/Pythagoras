...
with BuildPart() as blocks:
    Add(winch_generator.generate_winch(winch_generator.test_cable_fun, 20))
    with Locations((20,0,0)):
        Add(winch_generator.generate_winch(sine_winch, 20))
    with Locations((40,0,0)):
        Add(winch_generator.generate_winch(quadratic_winch, 20))
